...
sap.ui.require(
  [
    ...
    "sap/ui/qunit/qunit-junit",
    "sap/ui/qunit/qunit-coverage",
    "com/employee/employeelist/test/integration/FirstJourney",
    "com/employee/employeelist/test/integration/EmployeesListJourney",
    "com/employee/employeelist/test/integration/EmployeesObjectPageJourney",
], function (QUnit) {
    "use strict";
    QUnit.start();
});
